...
2. Importe o arquivo `n8n/Webhook -_ Supabase.json`
3. Configure a credencial do Supabase com sua URL e Service Role Secret
4. Ative o workflow
...
- [x] Autenticação — webhook de cadastro de professor (INSERT)
- [ ] Autenticação — webhook de login (SELECT + verificar senha)
- [ ] Frontend — tela de login e cadastro
- [ ] Frontend — steps de input (código habilidade → objeto conhecimento → observações)
- [ ] Integração Claude — gerar as 4 colunas do planejamento
- [ ] Salvar planejamento no banco
- [ ] Listagem de planejamentos salvos ("Projetos prontos")
...
## Status
Em desenvolvimento — Fase 2 em andamento (autenticação)
Concluído: webhook de cadastro de professor conectado ao Supabase
Próximo: webhook de login
